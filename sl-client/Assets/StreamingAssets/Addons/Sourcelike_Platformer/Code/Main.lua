AddonName = Utils.ReturnAddonName()
...
function LoadSprites()
    CL2D.LoadSprite("Addons/"..AddonName.."/Textures/World/Island.png", 0, 8, true)
    CL2D.LoadSprite("Addons/"..AddonName.."/Textures/World/Grass_01.png", 1, 16, true)
    CL2D.LoadSprite("Addons/"..AddonName.."/Textures/World/Grass_02.png", 2, 16, true)
    CL2D.LoadSprite("Addons/"..AddonName.."/Textures/World/Grass_03.png", 3, 16, true)
    CL2D.LoadSprite("Addons/"..AddonName.."/Textures/World/Grass_04.png", 4, 16, true)
    CL2D.LoadSprite("Addons/"..AddonName.."/Textures/World/Tree_01.png", 5, 16, true)
    CL2D.LoadSprite("Addons/"..AddonName.."/Textures/Sky.png", 6, 16, true)
    CL2D.LoadSprite("Addons/"..AddonName.."/Textures/Player/Player_01.png", 7, 16, true)
    CL2D.LoadSprite("Addons/"..AddonName.."/Textures/Player/Player_02.png", 8, 16, true)
    CL2D.LoadSprite("Addons/"..AddonName.."/Textures/Player/Player_03.png", 9, 16, true)
